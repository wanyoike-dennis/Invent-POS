...
function SuperAdminOrganizations() {
  ...
  const updateStatusFilter = (nextStatus: "all" | OrganizationStatus) => {
            ...
            <div className="mb-7 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                  Manage customer organizations, subscription access, billing and
                  platform users from one dedicated workspace.
                </p>
              </div>
            ...
            <div className="mt-5 grid gap-5 xl:grid-cols-[1.05fr_1fr]">
              ...
              <section className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-[0_3px_16px_rgba(15,23,42,0.035)]">
                ...
                <div className="mt-4 space-y-2.5">
                  ...
                  <button
                    type="button"
                    onClick={() => updateStatusFilter("suspended")}
